...
판정하는 것**이 되었다. 근거와 1차 소스는 [원칙 문서 §3](/thinkit/docs/principles/#3-지시-충돌이-왜-비용인가)에 있다.
...
판정 기준은 [Gotcha와 repo-visible](/thinkit/docs/principles/gotcha-vs-repo-visible/)에 있다.
